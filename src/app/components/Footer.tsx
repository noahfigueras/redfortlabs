      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2">
            <LogoWithText iconSize={40} />
            <p className="mt-4 text-gray-400 text-sm leading-relaxed max-w-xs">
              Building unbreakable digital fortresses through AI, blockchain, and 
            ...
            <div className="flex gap-4 mt-6">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-10 h-10 rounded-lg bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-[#dc2626] hover:text-white transition-all duration-200"
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} RedFortLabs. All rights reserved.
          </p>
